...
const SpaceService = {
  ...
  getSpaces: async (): Promise<Space[]> => {
    const response = await fetch(`${API_BASE_URL}/api/space/get_spaces`, {
  ...
  getSubspacesBySpaceId: async (spaceId: string, userId: string): Promise<Subspace[]> => {
    const payload = { space_id: spaceId };
    const response = await fetch(`${API_BASE_URL}/api/subspace/get_subspaces_for_space`, {
      method: "POST",
      headers: SpaceService.getHeaders(),
  ...
  getWordpadsBySubspace: async (subspaceId: string, userId: string): Promise<Wordpad[]> => {
    const response = await fetch(`${API_BASE_URL}/api/wordpad/get_all_wordpads`, {
      headers: SpaceService.getHeaders()
    });
    const data = await response.json();
  ...
  createSubspace: async (payload: { space_id: string; user_id: string; name: string }) => {
    const response = await fetch(`${API_BASE_URL}/api/subspace/add_subspace`, {
      method: 'POST',
      headers: SpaceService.getHeaders(),
      body: JSON.stringify(payload),
    });
  ...
  getTodoDataBySubspace: async (subspaceId: string, userId: string): Promise<Todo[]> => {
    const payload = { subspace_id: subspaceId };
    const response = await fetch(`${API_BASE_URL}/api/todo-wordpad/get_lastest_version_todo_wordpad`, {
      method: "POST",
      headers: SpaceService.getHeaders(),
      body: JSON.stringify(payload)
    });
  ...
  createWordpad: async (payload: {
    ...
    const response = await fetch(`${API_BASE_URL}/api/wordpad/add_wordpad`, {
      method: 'POST',
      headers: SpaceService.getHeaders(),
      body: JSON.stringify({
        ...payload,
  ...
  deleteWordpad: async (wordpadId: string, userId: string) => {
    const payload = { wordpad_id: wordpadId }
    const response = await fetch(`${API_BASE_URL}/api/wordpad/delete_wordpad`, {
      method: 'POST',
      headers: SpaceService.getHeaders(),
      body: JSON.stringify(payload)
    });
  ...
  createTodo: async (data: {
    ...
    const response = await fetch(`${API_BASE_URL}/api/todo/add_todo`, {
      method: 'POST',
      headers: SpaceService.getHeaders(),
      body: JSON.stringify(payload),
    });
